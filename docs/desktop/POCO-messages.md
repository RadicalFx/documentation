The Radical [[message broker|The message broker]] supports also POCO messages, it is not required, anymore, that a class, in order to be a first class message, implements the IMessage interface.
