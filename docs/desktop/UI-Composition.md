...
Once e View contains a region each that View is loaded a `ViewLoaded` message is broadcasted to notify that the View has been loaded:
...
* [Radical built-in messages](Built-in-messages)
